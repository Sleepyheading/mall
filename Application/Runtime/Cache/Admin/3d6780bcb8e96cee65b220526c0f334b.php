					...
					<div class="modal-content">
						<form id="singcms-form"  >
							<div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabel">添加子级分类</h4>
							</div>
				...
				<table class="table table-hover singcms-table">
					...
					<tbody>
						<?php if(is_array($class)): $i = 0; $__LIST__ = $class;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
							...
							<td>
								<a href="javascript:void(0)" attr-id="<?php echo ($v["class_id"]); ?>" class="singcms-delete"  attr-a="admin" attr-message="删除">
							...
							<tfoot>
								<tr>
									<td colspan="4"><?php echo ($pageRes); ?></td>
								</tr>
							</tfoot>
						</table>
					</div>
